...
//! DTS Decoder Ver 2 Define

#ifdef	INCLUDE_DTS_Ver2
...
{	
	...
	struct 
	{
		...
		//!     upsampling flag ( 0 : disable, 1: enable). 	only, if( ( m_iAACForceUpsampling == 1 ) && ( samplerate <= 24000 ) ), then out_samplerate = samplerate*2
		int		m_iAACForceUpsampling;
		//!		upmix (mono to stereo) flag (0 : disable, 1: enable). only, if( ( m_iAACForceUpmix == 1 ) && ( channel == mono ) ), then out_channel = 2;
 ...
 ***********************************************************************
 * \brief
 *		TCC_A52_DEC		: main api function of A52 decoder
 * \param
 *		[in]Op			: decoder operation 
 * \param
 *		[in,out]pHandle	: handle of A52 decoder
 * \param
 *		[in]pParam1		: init or input parameter
 * \param
 *		[in]pParam2		: output or information parameter
 * \return
 *		If successful, TCC_A52_DEC returns 0 or plus. Otherwise, it returns a minus value.
 ***********************************************************************
 */
 ...
 ***********************************************************************
 * \brief
 *		TCC_MP1_DEC		: main api function of mp1 decoder
 * \param
 *		[in]Op			: decoder operation 
 * \param
 *		[in,out]pHandle	: handle of mp1 decoder
 * \param
 *		[in]pParam1		: init or input parameter
 * \param
 *		[in]pParam2		: output or information parameter
 * \return
 *		If successful, TCC_MP1_DEC returns 0 or plus. Otherwise, it returns a minus value.
 ***********************************************************************
 */
int TCC_MP1_DEC( int iOpCode, int* pHandle, void* pParam1, void* pParam2 );
#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif //_ADEC_H_
