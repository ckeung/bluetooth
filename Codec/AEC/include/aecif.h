...
typedef enum
{
    ...
    AEC_DUMP_RCV = 0, /* Dump Raw received PCM */
    AEC_DUMP_RAG,  /* Dump Volume control PCM in Receiving path */
    AEC_DUMP_RDR,  /* Dump DRC PCM in Receiving path */
    AEC_DUMP_RDQ,  /* Dump DEQ PCM in Receiving path */
